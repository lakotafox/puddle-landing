...
const fragmentShader = `
  ...
  vec3 applyDuotone(vec3 c) {
    ...
    // Puddle duotone: deep indigo shadows -> light-blue/lavender highlights.
    vec3 shadow = vec3(0.04, 0.03, 0.22), highlight = vec3(0.62, 0.82, 1.0);
    vec3 duo = mix(shadow, highlight, smoothstep(0.0, 1.0, lum));
    float shift = (c.b - c.r) * 0.12;
    duo.b += shift; duo.r -= shift * 0.5;
