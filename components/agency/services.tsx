...
const services = [
  { id: 1, title: "Instant Access" },
  { id: 2, title: "Lower Turnover" },
  { id: 3, title: "Flexible Payouts" },
  { id: 4, title: "Zero Employer Cost" },
];
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <SplitText>Payday shouldn&apos;t make people wait. Money should move like they do.</SplitText>
        </h2>
      </div>
