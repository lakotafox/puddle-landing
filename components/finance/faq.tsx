...
const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer:
      "Immediately. There's no payday and no waiting period — the money reaches them the moment it's earned. They can spend it mid-shift, after work, or let it build up. It's their call.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Minutes, not weeks. Create an account, add your team, and start streaming wages. There's nothing for your workers to install to watch their earnings grow and arrive.",
  },
];
